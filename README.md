...
OURs - web-инструмент для сканирования активов в сети. Проведения брутфорс-атак на сервисы: ssh, ftp. Фаззинга директорий веб приложения. Поиска известных уязвимостей сервисов, с помощью утилиты SearchSploit
