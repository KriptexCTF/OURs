# OURs
### OURs - web-инструмент для сканирования активов в сети<br>Проведения брутфорс-атак на сервисы: ssh, ftp<br>Фаззинга директорий веб приложения<br>Поиска известных уфзвимостей сервисов, с помощью утилиты SearchSploit
